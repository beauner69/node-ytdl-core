...
const minigetLib = require("./_miniget"); // ZEROLABS
...
ytdl.getInfo = getInfo.getInfo; // ZEROLABS
...
*/ // ZeroLabs Additions
ytdl.InstallMiniGet = (miniget, minipromise) => {
  minigetLib.set(miniget, minipromise);
};

ytdl.getInfoFromYTID = getInfo.getInfoFromYTID;
